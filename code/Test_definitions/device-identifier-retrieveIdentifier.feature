...
Feature: Camara Mobile Device Identifer API, v0.4.0-alpha.1 - Operation: retrieveIdentifier
  ...
  Background: Common Device Identifier retrieveIdentifier setup
    ...
    And the resource "/device-identifier/v0.4alpha1/retrieve-identifier"
