...
## Discussions
### API Definition
- Eric presented an overview of the current [API definition](https://github.com/camaraproject/DeviceIdentifier/blob/r3.2/code/API_definitions/CAMARA%20Device%20Identifier%20API.yaml). The following points were clarified:
